...
Make up some fake data, or better yet use HolNguGoodVert data.

Read in parameter estimates

```{r}

estimates<- read.csv(file="backwards2E1_paramEstimates.csv", header=TRUE, sep=",")
